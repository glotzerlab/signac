...
class CollectionTest(unittest.TestCase):
    ...
    def test_contains(self):
        ...
        del self.c[0]
        self.assertFalse(0 in self.c)
        docs = [dict(_id=i) for i in range(10)]
        self.c.update(docs)
        for _id in self.c:
    ...
    def test_iteration(self):
        ...
        self.assertEqual(list(self.c.find()), docs)
    ...
    def test_find_types(self):
        ...
        for i, t in enumerate(t):
            self.c.clear()
            doc = self.c[i] = dict( a=t)
            self.assertEqual(list(self.c.find(doc)), [self.c[i]])
    ...
    def test_replace_one(self):
        ...
        self.c.update(docs)
        for doc, doc_ in zip(self.c.find(), docs_):
            self.c.replace_one(doc, doc_)
        self.assertEqual(len(self.c), len(docs))
        self.assertEqual(len(list(self.c.find())), len(docs))
        self.assertEqual(list(self.c.find()), docs_)
