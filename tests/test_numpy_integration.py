...
class TestNumpyIntegration(TestBaseProject):

    def test_store_number_in_sp_and_doc(self,setUp):
        for i in range(10):
    ...
    def test_store_array_in_sp(self,setUp):
        for i in range(10):
    ...
    def test_store_array_in_doc(self,setUp):
        for i in range(10):
