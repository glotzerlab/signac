...
class Project:
    ...
    def groupby(self, key=None, default=None):
        ...
        key : str, iterable, or callable, optional
            The grouping key(s) passed as a string, iterable of strings, or a
            callable that will be passed one argument, the job (Default value =
            None).
        default : object, optional
            A default value to be used when a given key is not present. The
            value must be sortable and is only used if not None (Default value
            = None).
...
class JobsCursor:
    ...
    def groupby(self, key=None, default=None):
        ...
        key : str, iterable, or callable, optional
            The grouping key(s) passed as a string, iterable of strings, or a
            callable that will be passed one argument, the job. If None, the
            job id is used (Default value = None).
        default : object, optional
            A default value to be used when a given key is not present. The
            value must be sortable and is only used if not None (Default value
            = None).
